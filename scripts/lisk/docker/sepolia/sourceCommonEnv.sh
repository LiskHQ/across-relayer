...
RPC_PROVIDER_LISK_11155111=`echo $RELAYER_CONFIG | jq -r ."RPC_PROVIDER_LISK_11155111"`
echo "RPC_PROVIDER_LISK_11155111=$RPC_PROVIDER_LISK_11155111" >> ${env_file}
...
RPC_PROVIDER_LISK_4202=`echo $RELAYER_CONFIG | jq -r ."RPC_PROVIDER_LISK_4202"`
echo "RPC_PROVIDER_LISK_4202=$RPC_PROVIDER_LISK_4202" >> ${env_file}
...
echo "RPC_PROVIDERS_11155111=$RPC_PROVIDERS_11155111" >> ${env_file}

RPC_PROVIDERS_4202=`echo $RELAYER_CONFIG | jq -r ."RPC_PROVIDERS_4202"`
echo "RPC_PROVIDERS_4202=$RPC_PROVIDERS_4202" >> ${env_file}
...
# Use only WETH until Across adds rebalancer support for LSK on Sepolia
# echo RELAYER_TOKENS=\'[\"0x16B840bA01e2b05fc2268eAf6d18892a11EC29D6\", \"0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14\"]\'  >> ${env_file}
